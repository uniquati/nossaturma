...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    dezAnos.init('photos/dezAnos2020', '10anos-bg.jpg', '10anos-bg.jpg', '10 anos', 'Como diria o filósofo: "10 anos não são 10 dias. 10 anos são 3653 dias (se contar anos bissextos)"', 'Praia de Perobas, Rio do Fogo/RN, 08 de Março de 2020', 3, '');
