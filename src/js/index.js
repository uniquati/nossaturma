...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    confraternizacao2015.init('photos/confraternizacao2015', 'confraternizacao-bg.jpg', 'confraternizacao-bg.jpg', 'Um Bom Encontro', 'Confraternização, Far Far Away..., 19 de Julho de 2015', 10);
    ...
    ultimoDia2014.init('photos/ultimodia2014', 'ultimodia-bg.jpg', 'ultimodia-bg.jpg', 'Último Dia em Escala Nanométrica', 'Invasão da piscina no último dia de aula, IFRN-ZN, 17 de Fevereiro de 2014', 10);
    ...
    rodizio2013.init('photos/rodizio2013', 'rodizio-bg.jpg', 'rodizio-bg.jpg', 'GeraPizza', 'Rodízio de pizza, Dom Gourmet, Natal/RN, 21 de Dezembro de 2013', 10);
    ...
    olinda2012.init('photos/olinda2012', 'olinda-bg.jpg', 'olinda-bg.jpg', 'O quarto do mofo', 'Recife e Olinda/PE, 19 de Janeiro de 2012', 10);
    
    const zueiraFacebook = new Album(firebase);
    zueiraFacebook.init('photos/zueira', 'zueira-bg.jpg', 'zueira-bg.jpg', 'Caaaaaaaara, tu não tá ligado!', 'Eu tenho certeza que vocês estão escondendo mais de um milhão de fotos não compartilhadas. Essa é a minha vingança.', 10);
    //Cheguei, chegastes
    //ip do halo
    //negueba ô
